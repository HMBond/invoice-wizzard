...
var app = (function () {
    ...
    const wizzard = writable({
      ...
      save: () => {
        if (get_store_value(wizzard).visible) ;
    ...
    class StepOne extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { state: 0, invoice: 1 });
    	}
    }
    ...
    function create_fragment$5(ctx) {
    	...
    	let div4;
    	let div1;
    	let t2_value = /*$invoice*/ ctx[0].addressee.name + "";
    	let t2;
    	let t3;
    	let div2;
    	let t4_value = /*$invoice*/ ctx[0].addressee.address + "";
    	let t4;
    	let t5;
    	let div3;
    	let span0;
    	let t6_value = /*$invoice*/ ctx[0].addressee.postcode + "";
    	let t6;
    	let t7;
    	let span1;
    	let t8_value = /*$invoice*/ ctx[0].addressee.city + "";
    	let t8;
    	let t9;
    	let div7;
    	let div5;
    	...
    	let t11;
    	let span3;
    	let t12_value = /*$invoice*/ ctx[0].id + "";
    	let t12;
    	let t13;
    	let div6;
    	let span4;
    	let t15;
    	let span5;
    	let raw_value = /*$invoice*/ ctx[0].description + "";
    	let t16;
    	let div10;
    	let div8;
    	let span6;
    	let t18;
    	let span7;
    	let t19_value = /*$invoice*/ ctx[0].invoiceDate + "";
    	let t19;
    	let t20;
    	let div9;
    	let span8;
    	let t22;
    	let span9;
    	let t23_value = /*$invoice*/ ctx[0].expirationDate + "";
    	let t23;
    	let t24;
    	let div12;
    	let t33;
    	...
    	return {
    		c() {
    			main = element("main");
    			div0 = element("div");
    			div0.innerHTML = `<img src="images/logo.png" alt="logo"/>`;
    			t0 = space();
    			...
    			div12.innerHTML = `<div class="header"><span></span> 
      ...
      <span class="text-align-right">Btw</span></div>`;
    			...
    			t34 = space();
    			create_component(wizzard.$$.fragment);
    			attr(div0, "class", "logo");
    			attr(div4, "class", "addressee");
    			attr(div5, "class", "invoice-id");
    			attr(span4, "class", "description");
    			attr(div6, "class", "invoice-description");
    			attr(div7, "class", "invoice-info");
    			attr(div10, "class", "dates");
    			attr(div12, "class", "items");
    		},
    		m(target, anchor) {
    			...
    			mount_component(wizzard, target, anchor);
    			current = true;
    		},
    		p(ctx, [dirty]) {
    			if ((!current || dirty & /*$invoice*/ 1) && t2_value !== (t2_value = /*$invoice*/ ctx[0].addressee.name + "")) set_data(t2, t2_value);
    			if ((!current || dirty & /*$invoice*/ 1) && t4_value !== (t4_value = /*$invoice*/ ctx[0].addressee.address + "")) set_data(t4, t4_value);
    			if ((!current || dirty & /*$invoice*/ 1) && t6_value !== (t6_value = /*$invoice*/ ctx[0].addressee.postcode + "")) set_data(t6, t6_value);
    			if ((!current || dirty & /*$invoice*/ 1) && t8_value !== (t8_value = /*$invoice*/ ctx[0].addressee.city + "")) set_data(t8, t8_value);
    			if ((!current || dirty & /*$invoice*/ 1) && t12_value !== (t12_value = /*$invoice*/ ctx[0].id + "")) set_data(t12, t12_value);
    			if ((!current || dirty & /*$invoice*/ 1) && raw_value !== (raw_value = /*$invoice*/ ctx[0].description + "")) span5.innerHTML = raw_value;			if ((!current || dirty & /*$invoice*/ 1) && t19_value !== (t19_value = /*$invoice*/ ctx[0].invoiceDate + "")) set_data(t19, t19_value);
    			if ((!current || dirty & /*$invoice*/ 1) && t23_value !== (t23_value = /*$invoice*/ ctx[0].expirationDate + "")) set_data(t23, t23_value);
    		},
    		i(local) {
    			if (current) return;
    			transition_in(contact.$$.fragment, local);
    			transition_in(footer.$$.fragment, local);
    			transition_in(wizzard.$$.fragment, local);
    			current = true;
    		},
    		o(local) {
    			transition_out(contact.$$.fragment, local);
    			transition_out(footer.$$.fragment, local);
    			transition_out(wizzard.$$.fragment, local);
    			current = false;
    		},
    		d(detaching) {
    			...
    			destroy_component(wizzard, detaching);
    		}
    	};
    }
    ...
    function exportAsPfd() {
    	window.print(); // todo: environment check
